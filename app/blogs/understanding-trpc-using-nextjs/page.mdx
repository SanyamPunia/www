...
<Image className="w-full select-none" draggable="false" src={ClientSideResponse} alt="client-side-response" />

## Directory Structure
Here is the final directory structure for reference purposes. This is the one recommended by tRPC itself.

<Image className="w-full select-none" draggable="false" src={DirectoryStr} alt="directory-str" />
