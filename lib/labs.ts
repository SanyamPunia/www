...
export const labsRegistry: LabMetadata[] = [
  ...
  },
  {
    ...
    title: "Pixel Reveal",
    description: [
      "One flat tile. Pick one of five pictures from the strip under the board, press generate, and that tile splits into four, then sixteen, and keeps halving until the tiles are small enough to stop being tiles, at which point the picture itself arrives over the top. Save writes what resolved to a PNG, and the three numbers driving the run are behind tune.",
