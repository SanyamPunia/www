...
const EXPERIMENTS: Record<ImplementedLab, React.ComponentType> = {
  ...
  "stamp-collection": dynamic(
    () => import("@/components/labs/stamp-collection"),
    {
      ssr: false,
    },
  ),
  ...
  "halftone-ripple": dynamic(
    () => import("@/components/labs/halftone-ripple"),
    {
      ssr: false,
    },
  ),
  ...
  "book-shelf": dynamic(() => import("@/components/labs/book-shelf"), {
    ssr: false,
  }),
  ...
  "foil-card": dynamic(() => import("@/components/labs/foil-card"), {
    ssr: false,
  }),
