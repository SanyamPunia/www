    ...
    <div className="w-full max-w-3xl space-y-4">
      <div className="flex justify-center space-x-2">
        <button
          ...
          className="w-20 text-xs h-8 border border-[#1b1b1b] rounded cursor-pointer hover:bg-zinc-900 transition-all"
        >
...
function TextDisplay({ title, content }: { title: string; content: string }) {
  return (
    <div className="space-y-1 border border-[#131313] pt-2 rounded-md">
