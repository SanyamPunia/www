...
/**
 * Pageo mark. Not on svgl, so this is the site's own copy, re-inked from the
 * dark build's `#fff` to the black their favicon actually uses.
 */
export function Pageo(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 375 375"
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      // decorative by default, call sites label the link that wraps it
      aria-hidden="true"
      focusable="false"
      {...props}
    >
